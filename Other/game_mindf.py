...
#Picture Directories
PICTROOTDIR=r"I:\bin\tmp\ESTIM\PROGRAMMING\\"
pictRootDir0 = PICTROOTDIR + r"GuideMe-v0.4.3-Windows.64-bit\Mindfuck\Estim Mindfuck Edging Loops - by sub090\\"

PICTROOTDIRLIST = [pictRootDir0]
PAINPICTROOTDIRLIST = [pictRootDir0]
